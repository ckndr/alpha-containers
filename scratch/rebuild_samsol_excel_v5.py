...
# 6. Parse PET dispatches (dispatch pet nov to jul.xls)
    ...
    if current_pet_prod:
        try:
            ...
            if resolved_name:
                ...
                is_samsol = cat_cust and ('samsol' in str(cat_cust).lower() or 'abid' in str(cat_cust).lower() or 'mateen' in str(cat_cust).lower())
