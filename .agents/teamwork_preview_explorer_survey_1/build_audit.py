...
sections.append("""# Requirement R1: Data Pipeline & Script Reliability Forensic Audit Report
...
---
""")
sections.append("""## 3. Deep Forensic Investigation by Script & Module
...
""")
sections.append("""### 3.3. `Scripts/update_dispatch.py`
...
""")
sections.append("""### 3.6. `Scripts/daily.py`
...
out_path = r"d:\Alpha\.agents\teamwork_preview_explorer_survey_1\r1_pipeline_audit.md"
full_text = "".join(sections)
with open(out_path, "w", encoding="utf-8") as f:
    f.write(full_text)

print(f"Generated {out_path} ({len(full_text)} chars, {len(sections)} sections)")
